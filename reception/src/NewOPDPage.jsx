...
function NewOPDPage() {
  ...
  return (
    <div className="p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-bold text-charcoal-grey mb-6 border-b pb-3">New OPD Registration</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input type="text" id="patientName" value={patientName} onChange={(e) => setPatientName(e.target.value)}
                 className="mt-1 block w-full px-3 py-2 bg-white border border-cornflower-blue rounded-md shadow-sm focus:outline-none focus:ring-cornflower-blue focus:border-cornflower-blue sm:text-sm" required />
        </div>
        ...
        <div>
          ...
          <textarea id="address" value={address} onChange={(e) => setAddress(e.target.value)} rows="3"
                    className="mt-1 block w-full px-3 py-2 bg-white border border-cornflower-blue rounded-md shadow-sm focus:outline-none focus:ring-cornflower-blue focus:border-cornflower-blue sm:text-sm"></textarea>
        </div>

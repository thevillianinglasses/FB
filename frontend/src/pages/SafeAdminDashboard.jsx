...
function SafeAdminDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Statistics Cards - Always render even if data unavailable */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <Link
          to="/admin/users"
          className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 hover:shadow-md transition-all duration-300 group block"
        >
          <div className="flex items-center">
            <div className="w-16 h-16 bg-blue-600 rounded-xl flex items-center justify-center text-white text-2xl group-hover:scale-105 transition-transform">
              👥
            </div>
            <div className="ml-6">
      ...
      <Link
        to="/admin/doctors"
        className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-8 hover:shadow-lg transition-all duration-300 group block"
      >

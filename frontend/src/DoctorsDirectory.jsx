        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <input
                type="text"
                placeholder="Search by name, degree, specialty..."
                value={searchQuery}
        ...
        {!isLoading && filteredDepartments.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDepartments.map((department, index) => (
              <div key={department.name + index} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                {/* Department Header */}
                <div className="bg-cornflower-blue text-white px-6 py-4">
                  <h3 className="text-lg font-semibold">{department.name}</h3>
                  <p className="text-blue-100 text-sm">{department.doctors.length} doctor{department.doctors.length !== 1 ? 's' : ''}</p>
                </div>
                ...
                <div className="p-6">
                  {department.doctors.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <button
                        onClick={handleAddNewDoctor}
                        className="mt-3 text-cornflower-blue hover:text-blue-700 text-sm font-medium"
                      >
                        Add first doctor
                      </button>
                    </div>
                            ...
                            <div className="flex-1">
                              ...
                              {doctor.phone && (
                                <div className="flex items-center text-xs text-gray-500 mt-2">
                                  ...
                                  <span>Fee: ₹{doctor.default_fee || '500'}</span>
                                </div>
                              )}
                            </div>
